...
namespace ExcelExportWeek04
{
    public partial class Form1 : Form
    {
        ...
        private void CreateTable()
        {
            ...
            Excel.Range firstColoumn = xlSheet.get_Range(GetCell(2, 1), GetCell(1 + values.GetLength(0), 1));
            firstColoumn.Font.Bold = true;
            firstColoumn.Interior.Color = Color.LightYellow;

            Excel.Range lastColoumn = xlSheet.get_Range(GetCell(2, values.GetLength(1)), GetCell(1 + values.GetLength(0), values.GetLength(1)));
            lastColoumn.Interior.Color = Color.LightGreen;
            lastColoumn.NumberFormat = "###,###.00";
        }
    }
}
